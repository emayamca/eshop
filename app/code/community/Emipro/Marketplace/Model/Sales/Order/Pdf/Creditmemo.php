<?php
class Emipro_Marketplace_Model_Sales_Order_Pdf_Creditmemo extends Mage_Sales_Model_Order_Pdf_Creditmemo
{
    public function getPdf($creditmemos = array())
    {
        ...
        foreach ($creditmemos as $creditmemo) {
            ...
            if($creditmemo->getSellerId()){
                $sellerid= $creditmemo->getSellerId();
                ...
                if($sellerdetail->getId()){
                    ...
                    $page->drawRectangle(25, 820, 570, (820 - 25));
                    $this->_setFontBold($page, 12);
                    $page->setFillColor(new Zend_Pdf_Color_GrayScale(0));
                    $page->drawText(Mage::helper('sales')->__('Sold By').' : '.$storename, 35, 806, 'UTF-8');
                }
            }
	...
	protected function insertOrder(&$page, $obj, $putOrderId = true)
    {
        ...
        if ($order->getIsVirtual()) {
			...
			{ 
				$shipFees=Mage::helper('marketplace')->getSellerShippingFees($order->getId(),$sellerid);
				$totalShippingChargesText = "(" . Mage::helper('sales')->__('Total Shipping Charges') . " "
