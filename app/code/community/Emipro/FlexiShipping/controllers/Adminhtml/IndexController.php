 ...
 * //////////////////////////////////////////////////////////////////////////////////////
 */
class Emipro_FlexiShipping_Adminhtml_IndexController extends Mage_Adminhtml_Controller_Action
{   
    public function indexAction()
    {
		$this->loadLayout();
		$this->getLayout()->getBlock('head')->setTitle($this->__('Flexi Shipping Method').' - '.Mage::getStoreConfig('general/store_information/name',Mage::app()->getStore()->getId())); 
		$this->_setActiveMenu('marketplace/flexishipping');
		$this->_addContent($this->getLayout()->createBlock('emipro_flexishipping/adminhtml_flexiShipping'));
        $this->renderLayout();
    }
     public function gridAction()
    {
        ...
        $this->getResponse()->setBody(
            $this->getLayout()->createBlock('emipro_flexishipping/adminhtml_flexiShipping_grid')->toHtml()
        );
    }
   ...
   public function editAction()
		...
		{	
			try 
			{
               ...
               if($ship_fees==1)
                ...
                $this->_getSession()->addError(
                    Mage::helper('emipro_flexishipping')->__('An error occurred while saving the rule data. Please review the log and try again.')
                );
                Mage::logException($e);
	...
	public function applyRulesAction()
    {
        ...
        try {
            ...
            $this->_getSession()->addSuccess(Mage::helper('emipro_flexishipping')->__('The rules have been applied.'));
        } catch (Mage_Core_Exception $e) {
  ...
  public function deleteAction()
	...
	{ 
		return Mage::getSingleton('admin/session')->isAllowed('marketplace/flexishipping');   
    }
}
