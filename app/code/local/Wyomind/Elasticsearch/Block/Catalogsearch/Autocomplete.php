 ...
 */
class Wyomind_Elasticsearch_Block_Catalogsearch_Autocomplete extends Wyomind_Elasticsearch_Block_Catalogsearch_Result
{
    /**
     * @var Wyomind_Elasticsearch_Helper_Autocomplete
     */
    protected $_helper;
    ...
    public function getCategoryCollection()
    {
        ...
        if (!$this->_categories) {
            ...
            if ($limit = $this->getAutocompleteLimit('category')) {
    ...
    public function getPageCollection()
    {
        ...
        if (!$this->_pages) {
            ...
            if ($limit = $this->getAutocompleteLimit('cms')) {
                $collection->getSelect()->limit($limit);
            }
    ...
    public function getProductCollection()
    {
        if (!$this->_products) {
            ...
            if ($limit = $this->getAutocompleteLimit("product")) {
                $collection->getSelect()->limit($limit);
            }
     ...
     *
     * @return Wyomind_Elasticsearch_Block_Catalogsearch_Autocomplete_Category
     */
     ...
     *
     * @return Wyomind_Elasticsearch_Block_Catalogsearch_Autocomplete_Cms
     */
    ...
    {
        return $this->_helper->getAutocompleteLimit($entity);
    }
     ...
     *
     * @param string $entity
     * @return Wyomind_Elasticsearch_Block_Catalogsearch_Result
     * @throws Exception
     */
