...
spl_autoload_register(array('Wyomind_Elasticsearch_Model_Autoload', 'load'), false, true);

class Wyomind_Elasticsearch_Model_Resource_Client extends Wyomind_Elasticsearch_Client
{
    /**
     * @var Wyomind_Elasticsearch_Helper_Data
     */
    protected $_helper;
     ...
     *
     * @param string $type
     * @return Wyomind_Elasticsearch_Helper_Indexer_Abstract
     */
    ...
    public function getStoreData($store = null, $ids = null, $type = 'product')
    {
        ...
        Mage::dispatchEvent('wyomind_elasticsearch_store_export_data', array(
            'type'  => $type,
            'store' => $store,
            'data'  => &$data,
        ));
    ...
    public function getStoreIndex($store = null, $new = false)
    {
        ...
        foreach ($this->_helper->getStoreTypes($store) as $type) {
            ...
            Mage::dispatchEvent('wyomind_elasticsearch_mapping_send_before', array(
                'client' => $this,
                'store' => $store,
                'mapping' => $mapping,
                'type' => $type,
     ...
     * @param $store
     * @param string $type
     * @return Wyomind_Elasticsearch_Type
     */
    public function getStoreType($store, $type = 'product')
    {
        return new Wyomind_Elasticsearch_Type($this->getStoreIndex($store), $type);
    }
    ...
    public function getSuggestFields()
    {
        ...
        Mage::dispatchEvent('wyomind_elasticsearch_suggest_fields', array(
            'client' => $this,
            'fields' => $fields,
        ));
    ...
    public function search($q, $store = null, $params = array(), $type = 'product')
    {
        ...
        Mage::dispatchEvent('wyomind_elasticsearch_before_search', array(
            'client' => $this,
            'search' => $search,
            'store' => $store,
            'type' => $type,
