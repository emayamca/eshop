 ...
 */
class Wyomind_Elasticsearch_Model_Resource_Engine extends Mage_CatalogSearch_Model_Resource_Fulltext_Engine
{
    /**
     ...
     *
     * @see Wyomind_Elasticsearch_Model_Resource_Client
     */
        ...
        try {
            foreach ($stores as $store) {
                ...
                if (!$active) {
                    ...
                    $this->cleanIndex($store,$ids,$type);
