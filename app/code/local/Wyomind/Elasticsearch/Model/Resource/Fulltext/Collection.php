 ...
 */
class Wyomind_Elasticsearch_Model_Resource_Fulltext_Collection extends Mage_CatalogSearch_Model_Resource_Fulltext_Collection
{
     ...
     * @return $this
     */
    protected function _setResults($query,
            $ids)
    {
    ...
    /**
     * @param string $query
     * @return Wyomind_Elasticsearch_Model_Resource_Fulltext_Collection
     */
