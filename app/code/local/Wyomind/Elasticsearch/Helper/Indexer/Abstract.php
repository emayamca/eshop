 ...
 */
abstract class Wyomind_Elasticsearch_Helper_Indexer_Abstract extends Wyomind_Elasticsearch_Helper_Data
{
     ...
     * @return array
     */
    public function getAttributeProperties(Mage_Eav_Model_Entity_Attribute $attribute,
            $store = null)
    {
