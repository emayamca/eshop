		...
		if($customer->getMobile()) {
            if($customer->getId()){
				$customerCollection = Mage::getModel('customer/customer')->getCollection()
									...
									->addAttributeToFilter('entity_id', array('neq' => (int)$customer->getId()))
									->addAttributeToFilter('website_id', array('eq' => (int)$customer->getWebsiteId()))
									->addAttributeToFilter('mobile', array('eq' => $customer->getMobile()));   
			} else {
				$customerCollection = Mage::getModel('customer/customer')->getCollection()
									->addAttributeToSelect('*')
									->addAttributeToFilter('website_id', array('eq' => (int)$customer->getWebsiteId()))
