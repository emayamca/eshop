 ...
 */
class Wyomind_Elasticsearch_Type extends \Elastica\Type
{
    /**
     * @var array
     */
     ...
     * @param string $name
     */
    public function __construct(Wyomind_Elasticsearch_Index $index, $name)
    {
    ...
    {
        /** @var Wyomind_Elasticsearch_Index $index */
        $index = $this->getIndex();
